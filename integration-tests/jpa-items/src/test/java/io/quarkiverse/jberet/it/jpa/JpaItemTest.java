...
class JpaItemTest {
    ...
    @Test
    void jpaProperties() throws Exception {
        BatchClient batchClient = new BatchClient(httpServer.getLocalBaseUri().toString());
        JobExecutionEntity jobExecution = batchClient.startJob("jpa-properties", new Properties());
    ...
    @Test
    void jpaNamedPersistenceUnit() throws Exception {
        BatchClient batchClient = new BatchClient(httpServer.getLocalBaseUri().toString());
        JobExecutionEntity jobExecution = batchClient.startJob("jpa-named-pu", new Properties());
    ...
    @Test
    void jpaBeans() throws Exception {
        BatchClient batchClient = new BatchClient(httpServer.getLocalBaseUri().toString());
        JobExecutionEntity jobExecution = batchClient.startJob("jpa-beans", new Properties());
