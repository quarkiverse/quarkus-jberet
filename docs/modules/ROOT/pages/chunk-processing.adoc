...
[source,java]
----
include::{examples-dir}/org/acme/batch/chunk/AuctionItemReader.java[]
----
...
[TIP]
====
Use `io.quarkiverse.jberet.runtime.api.ItemReader<T>` which support generic data types
====
...
[source,java]
----
include::{examples-dir}/org/acme/batch/chunk/AuctionItemProcessor.java[]
----
...
[TIP]
====
Use `io.quarkiverse.jberet.runtime.api.ItemProcessor<T, R>` which support generic data types
====
...
[source,java]
----
include::{examples-dir}/org/acme/batch/chunk/AuctionItemWriter.java[]
----
...
[TIP]
====
Use `io.quarkiverse.jberet.runtime.api.ItemWriter<T>` which support generic data types
====
...
[source,java]
----
include::{examples-dir}/org/acme/batch/chunk/AuctionCheckpointAlgorithm.java[]
----
